...
```text
P4_EEG/experiment/video/analysis/
```
...
```text
P4_EEG/experiment/video/launch_video_action_gui.bat
```
...
```text
experiment/data/video_records/camera_20260518_193936.mp4
```

界面会自动给出默认输出目录：

```text
experiment/video/analysis_outputs/camera_20260518_193936/
```
