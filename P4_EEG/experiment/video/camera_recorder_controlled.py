...
# 仅用于独立测试时的兜底；正式运行时由 launcher.get_camera_output_dir(cfg)
# 显式传入 <data_dir>/<scheme>/video_records，scheme 由 cfg.scheme 决定。
DEFAULT_OUTPUT_DIR = (SCRIPT_DIR / ".." / "data" / "motor_imagery" / "video_records").resolve()
