...
EO_DURATION_S_QUICK = 5
EC_DURATION_S_QUICK = 5
TRANSITION_DURATION_S_QUICK = 2.0
...
def run_session1(cfg: ExperimentConfig):
    ...
    eo_duration = EO_DURATION_S_QUICK if quick else EO_DURATION_S
    ec_duration = EC_DURATION_S_QUICK if quick else EC_DURATION_S
    transition_duration = TRANSITION_DURATION_S_QUICK if quick else TRANSITION_DURATION_S
    ...
    print(f"[Session 1] 睁眼静息开始 0/{eo_duration}s")
    ...
    print(f"[Session 1] 闭眼静息开始 0/{ec_duration}s")
