...
```text
scratch/video_records/analysis_outputs/<video_stem>/
```
...
python -m analysis.run_analysis --video scratch/video_records/camera_20260518_193936.mp4 --duration 60 --save-preview
```

处理完整视频：

```bash
python -m analysis.run_analysis --video scratch/video_records/camera_20260518_193936.mp4 --save-preview
```
