...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--device-name", default="FF-Camera", help="DirectShow device name for --backend ffmpeg-dshow.")
    parser.add_argument("--input-format", choices=["MJPG", "YUY2", "auto"], default="MJPG", help="Camera input format. MJPG is usually required for USB 1080p/30fps.")
